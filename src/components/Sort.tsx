...
export const sortList: sortItem[] = [
   ...
   { name: 'популярности (возрастанию)', sortProperty: SortPropertyEnum.RATING_ASC },
...
const Sort: FC<SortProps> = memo(({ value }) => {
   ...
   useEffect(() => {
      ...
      // функция вызывается при размонтировании компонента
   ...
   return (
      <div ref={sortRef} className="sort">
         <div className="sort__label">
            <svg
               className={value.sortProperty.includes('-') ? 'rotateSvg' : ''}
